  ...
  return (
    <Fragment>
      <Collapsible
        ...
        {data.active_tickets.filter(filterTicket).reverse().map(ticket => (
          <TicketSummary
            key={ticket.id}
            ticket={ticket}
            user={data.user_key} />
      ...
      <Collapsible
        className="ticket_section"
        color="green"
        title={"Closed Tickets (" + data.closed_tickets.filter(filterTicket).length + ")"}>
        {data.closed_tickets.filter(filterTicket).reverse().map(ticket => (
          <TicketSummary
            key={ticket.id}
            ticket={ticket}
            user={data.user_key} />
      ...
      <Collapsible
        className="ticket_section"
        color="green"
        title={"Resolved Tickets (" + data.resolved_tickets.filter(filterTicket).length + ")"}>
