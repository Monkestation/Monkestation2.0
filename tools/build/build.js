...
export const IconCutterTarget = new Juke.Target({
  ...
  inputs: ({ get }) => {
    const standard_inputs = [
      `icons/**/*.png.toml`,
      `icons/**/*.dmi.toml`,
      `monkestation/icons/**/*.png.toml`,
      `monkestation/icons/**/*.dmi.toml`,
    ...
    const existing_configs = [
      ...
      ...Juke.glob(`monkestation/icons/**/*.png.toml`),
      ...Juke.glob(`monkestation/icons/**/*.dmi.toml`),
    ];
    return [
      ...standard_inputs,
...
export const DmMapsIncludeTarget = new Juke.Target({
  executes: async () => {
    const folders = [
      ...Juke.glob('_maps/~monkestation/**/*.dmm'),
