...
/datum/controller/subsystem/job/proc/pick_desired_roundstart()
	...
	log_storyteller("p_d_r valid_rolesets: [english_list(valid_rolesets)]", list("rolesets" = valid_rolesets))
	...
	log_storyteller("p_d_r actual_valid_rolesets: [english_list(actual_valid_rolesets)]", list("rolesets" = actual_valid_rolesets))
