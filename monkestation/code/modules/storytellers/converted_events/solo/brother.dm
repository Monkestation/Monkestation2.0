/datum/round_event_control/antagonist/solo/brother
	...
	extra_spawned_events = list(
		/datum/round_event_control/antagonist/solo/traitor/roundstart = 9, //Traitors are always fun
		/datum/round_event_control/antagonist/solo/bloodsucker/roundstart = 1, //Bloodsuckers can vassalize people making very big teams.
		/datum/round_event_control/antagonist/solo/heretic/roundstart = 2, //Heretics cant convert crew to their side. So it gets a higher weight then Bloodsuckers
	)
