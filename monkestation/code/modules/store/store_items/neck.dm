GLOBAL_LIST_INIT(store_neck, generate_store_items(/datum/store_item/neck))


/datum/store_item/neck
...
/datum/store_item/neck/scarf_black
	name = "Black Scarf"
...
/datum/store_item/neck/stethoscope
	name = "Stethoscope"
