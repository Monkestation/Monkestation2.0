...
/obj/item/organ/internal/cyberimp/leg/table_glider/update_implants()
	if(!check_compatibility())
		REMOVE_TRAIT(owner,TRAIT_FAST_CLIMBER,CYBERNETIC_TRAIT)
		return
	ADD_TRAIT(owner,TRAIT_FAST_CLIMBER,CYBERNETIC_TRAIT)
...
/obj/item/organ/internal/cyberimp/leg/shove_resist/update_implants()
	if(!check_compatibility())
		REMOVE_TRAIT(owner,TRAIT_SHOVE_RESIST,CYBERNETIC_TRAIT)
		return
	ADD_TRAIT(owner,TRAIT_SHOVE_RESIST,CYBERNETIC_TRAIT)
...
/obj/item/organ/internal/cyberimp/leg/sprinter/update_implants()
	if(!check_compatibility())
		REMOVE_TRAIT(owner,TRAIT_FREERUNNING, CYBERNETIC_TRAIT)
		REMOVE_TRAIT(owner,TRAIT_LIGHT_STEP,CYBERNETIC_TRAIT)
		return
	ADD_TRAIT(owner,TRAIT_FREERUNNING,CYBERNETIC_TRAIT)
	ADD_TRAIT(owner,TRAIT_LIGHT_STEP,CYBERNETIC_TRAIT)
