...
ADMIN_VERB(reload_mentors, R_NONE, "Reload Mentors", "Reloads all mentors from the database.", ADMIN_CATEGORY_MAIN)
...
MENTOR_VERB(mreload_mentors, R_HEADMENTOR, "Reload Mentors", "Reloads all mentors from the database.", MENTOR_CATEGORY_MAIN)
