...
/datum/symptom/plasma_heal/first_activate(mob/living/carbon/mob, datum/disease/disease)
	. = ..()
...
/datum/symptom/plasma_heal/activate(mob/living/carbon/mob, datum/disease/disease)
	. = ..()
