...
/datum/symptom/adaptation/OnAdd(datum/disease/disease)
	disease.infectable_biotypes |= biotypes

/datum/symptom/adaptation/OnRemove(datum/disease/disease)
	disease.infectable_biotypes &= ~(biotypes)
...
/datum/symptom/adaptation/undead/OnAdd(datum/disease/disease)
	. = ..()
	disease.process_dead = TRUE

/datum/symptom/adaptation/undead/OnRemove(datum/disease/disease)
