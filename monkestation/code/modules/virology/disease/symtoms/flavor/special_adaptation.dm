...
/datum/symptom/adaptation/OnAdd(mob/living/carbon/mob, datum/disease/acute/disease)
	disease.infectable_biotypes |= biotypes

/datum/symptom/adaptation/OnRemove(mob/living/carbon/mob, datum/disease/acute/disease)
	disease.infectable_biotypes &= ~(biotypes)
...
/datum/symptom/adaptation/undead/OnAdd(mob/living/carbon/mob, datum/disease/acute/disease)
	.=..()
	disease.process_dead = TRUE

/datum/symptom/adaptation/undead/OnRemove(mob/living/carbon/mob, datum/disease/acute/disease)
