...
/datum/symptom/proc/run_effect(mob/living/carbon/mob, datum/disease/disease)
	if(isnull(mob))
...
/datum/symptom/proc/first_activate(mob/living/carbon/mob, datum/disease/disease)

// The actual guts of the effect. Has a prob(chance)% to get called per tick.
/datum/symptom/proc/activate(mob/living/carbon/mob, datum/disease/disease)
...
/datum/symptom/proc/deactivate(mob/living/carbon/mob, datum/disease/disease, safe = FALSE)
...
/datum/symptom/proc/disable_effect(mob/living/mob, datum/disease/disease, safe = FALSE)
	if (count > 0)
