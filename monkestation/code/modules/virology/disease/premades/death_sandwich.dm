/datum/disease/premade/death_sandwich_poisoning
...
/datum/disease/premade/death_sandwich_poisoning/after_add()
	. = ..()
	antigen = null
	stage = 3

/datum/disease/premade/death_sandwich_poisoning/activate(mob/living/mob, starved, seconds_per_tick)
	. = ..()
