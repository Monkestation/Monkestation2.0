...
/datum/borer_evolution/diveworm/dissection
	...
	gain_text = "After applying extreme radiation exposure to a sample of the eggs, the worm's host never produced any more eggs. However, the sanitation team noted these same worms remaining around a dead host they were to remove."
	tier = -1
