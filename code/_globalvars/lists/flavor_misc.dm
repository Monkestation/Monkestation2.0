...
GLOBAL_LIST_EMPTY(cetanoid_tail_list) //Monkestation Addition
GLOBAL_LIST_EMPTY(cetanoid_frills_list) //Monkestation Addition
GLOBAL_LIST_EMPTY(cetanoid_fins_list) //Monkestation Addition
