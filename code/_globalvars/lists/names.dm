...
GLOBAL_LIST_INIT(simian_last_names, world.file2list("strings/names/simian_last.txt"))
GLOBAL_LIST_INIT(simian_names_female, world.file2list("strings/names/simian_female_first.txt"))
GLOBAL_LIST_INIT(simian_names_male, world.file2list("strings/names/simian_male_first.txt"))
...
GLOBAL_LIST_INIT(lesser_vampire_house_names, world.file2list("strings/names/vampire_house_names.txt"))
