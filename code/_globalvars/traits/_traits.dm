...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_RANDOM_LAVALAND" = STATION_TRAIT_RANDOM_LAVALAND,
	),
	/datum/hud = list(
	...
	/obj/item = list(
		...
		"TRAIT_TASER_RESISTANCE" = TRAIT_TASER_RESISTANCE,
	...
	/obj/item/organ/internal/liver = list(
		...
		"TRAIT_GOBLIN_METABOLISM" = TRAIT_GOBLIN_METABOLISM,
	...
	/mob = list(
		...
		"TRAIT_BLOODSILVER_CURSE" = TRAIT_BLOODSILVER_CURSE,
		...
		"TRAIT_CAN_CLIMB_DISPOSALS" = TRAIT_CAN_CLIMB_DISPOSALS,
		...
		"TRAIT_CORRUPTED_MONITOR" = TRAIT_CORRUPTED_MONITOR,
		...
		"TRAIT_DETECTIVE" = TRAIT_DETECTIVE, // Mind?
