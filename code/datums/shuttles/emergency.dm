...
/datum/map_template/shuttle/emergency/haugan
	...
	(We need to deliver our mail in here as well, sorry for the mess), this shuttle is the premiere in transit of its time. (which has long passed) \
...
/datum/map_template/shuttle/emergency/hauganrefitted
	suffix = "hauganrefitted"
	name = "Cargo Refitted Yate Haugan Neo"
