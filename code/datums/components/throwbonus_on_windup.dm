...
/datum/component/throwbonus_on_windup/RegisterWithParent()
	...
	RegisterSignal(parent, COMSIG_MOVABLE_IMPACT, PROC_REF(on_thrown))

/datum/component/throwbonus_on_windup/UnregisterFromParent()
	UnregisterSignal(parent, list(COMSIG_ITEM_EQUIPPED, COMSIG_MOVABLE_MOVED, COMSIG_MOVABLE_IMPACT))
