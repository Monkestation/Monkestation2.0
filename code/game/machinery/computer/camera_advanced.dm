...
/mob/eye/ai_eye/remote/proc/transition_step(turf/destination, direction)
...
/mob/eye/ai_eye/remote/proc/allow_z_transition(datum/space_level/from, datum/space_level/into)
	return from == into
