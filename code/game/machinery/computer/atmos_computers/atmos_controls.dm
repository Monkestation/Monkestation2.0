...
/obj/machinery/computer/atmos_control/hexane_tank
	name = "Hexane Supply Control"
	circuit = /obj/item/circuitboard/computer/atmos_control/hexane_tank
	atmos_chambers = list(ATMOS_GAS_MONITOR_HEXANE = "Hexane Supply")
