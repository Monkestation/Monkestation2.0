...
/datum/game_mode/dynamic/proc/send_intercept()
	...
	if((selected_storyteller.star_colour == STARCOLOUR_GREENSTAR) || (SSgamemode.current_storyteller.disable_distribution))
	...
	else if(selected_storyteller.star_colour == STARCOLOUR_YELLOWSTAR)
	...
	else if(selected_storyteller.star_colour == STARCOLOUR_MIDNIGHTSUN)
		...
		. += "Advisory Level: <b>UNKNOWN</b></center><BR>"
		. += "Your sector's advisory level is UNKNOWN. The Department was unable gather any information about your sector. Prepare accordingly."
