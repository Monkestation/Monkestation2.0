...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	null, \
	//MONKE, not adding a special crafted pipe type.
	new/datum/stack_recipe("pipe", /obj/item/pipe/quaternary/pipe, 1, time = 4 SECONDS, check_density = FALSE, category = CAT_ATMOSPHERIC), \
	null, \
