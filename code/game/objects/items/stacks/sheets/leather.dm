...
GLOBAL_LIST_INIT(leather_recipes, list ( \
	...
	new/datum/stack_recipe("black leather satchel", /obj/item/storage/backpack/satchel/blackleather, 5, check_density = FALSE, category = CAT_CLOTHING), \ //MONKESTATION
	new/datum/stack_recipe("retro satchel", /obj/item/storage/backpack/satchel/retro, 5, check_density = FALSE, category = CAT_CLOTHING), \ //MONKESTATION
