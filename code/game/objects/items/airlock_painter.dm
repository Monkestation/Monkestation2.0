 ...
 */
/datum/asset/spritesheet_batched/decals/proc/blend_preview_floor(datum/universal_icon/decal) as /datum/universal_icon
	var/datum/universal_icon/floor_icon = uni_icon(preview_floor_icon, preview_floor_state)
	return floor_icon.blend_icon(decal, ICON_OVERLAY)
...
/datum/asset/spritesheet_batched/decals/proc/insert_state(decal, dir, color)
	...
	var/datum/universal_icon/final_icon = blend_preview_floor(uni_icon('icons/turf/decals.dmi', "[decal][icon_state_color ? "_" : ""][icon_state_color]", dir))
	insert_icon("[decal]_[dir]_[color]", final_icon)
