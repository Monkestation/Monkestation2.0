...
/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/spyglass
...
/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/proc/show_to_user(mob/user)//this is the meat of it. most of the map_popup usage is in this.
...
/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/proc/on_screen_clear(client/source, window)
	SIGNAL_HANDLER
	linked_bug.cam_screen.hide_from(source.mob)

/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/equipped(mob/user, slot)
	. = ..()
	if(!(slot & ITEM_SLOT_EYES))
		user.client?.close_popup("spypopup")

/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/dropped(mob/user)
	. = ..()
	user.client?.close_popup("spypopup")

/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/ui_action_click(mob/user)
	show_to_user(user)

/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/item_action_slot_check(slot)
	if(slot & ITEM_SLOT_EYES)
		return TRUE

/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/Destroy()
	if(linked_bug)
...
/obj/item/clothing/accessory/spy_bug
	...
	var/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/linked_glasses
...
/obj/item/storage/box/rxglasses/spyglasskit/PopulateContents()
	...
	var/obj/item/clothing/glasses/hud/security/sunglasses/spy/spy/newglasses = new(src)
