...
/obj/item/storage/box/cup/vials/PopulateContents()
	for(var/i in 1 to 7)
		new /obj/item/reagent_containers/cup/chemcanister(src)
...
/obj/item/storage/box/cup/vials/large/PopulateContents()
	for(var/i in 1 to 7)
		new /obj/item/reagent_containers/cup/chemcanister/large(src)
...
/obj/item/storage/box/cup/vials/bluespace/PopulateContents()
	for(var/i in 1 to 7)
		new /obj/item/reagent_containers/cup/chemcanister/bluespace(src)
...
/obj/item/storage/box/evilmeds/evilhypos/PopulateContents()
	var/list/items_inside = list(
		...
		/obj/item/reagent_containers/cup/chemcanister/bluespace = 6,
	)
	generate_items_inside(items_inside, src)
