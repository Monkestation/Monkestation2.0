...
Unfortunately, the most effective method my colleagues have so far found for inducing Conglomeration — <i>and let the Cloth bear witness to my truth</i> — is to, and I quote verbatim: 'press the two Constructs against eachother and rub them together suggestively.' ...Weep for us poor sinners, for we shall all be damned at the day of Judgement.
<br>
<br>
