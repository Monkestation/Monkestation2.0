...
DEFINE_WORLD_OBJECT_VERB(/obj/item, move_to_top, oview(1), "Move To Top", "", FALSE, "Object")
...
DEFINE_WORLD_OBJECT_VERB(/obj/item, verb_pickup, oview(1), "Pick up", "", FALSE, "Object")
