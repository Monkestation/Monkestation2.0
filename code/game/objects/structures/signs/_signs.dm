...
<<<<<<< HEAD
/obj/structure/sign/attackby(obj/item/attacking_item, mob/user, list/modifiers, list/attack_modifiers)
	if(is_editable && istype(attacking_item, /obj/item/pen))
=======
...
<<<<<<< HEAD
/obj/item/sign/attackby(obj/item/attacking_item, mob/user, list/modifiers, list/attack_modifiers)
	if(is_editable && istype(attacking_item, /obj/item/pen))
=======
