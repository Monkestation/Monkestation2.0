...
/// Items with this trait will not have their inhand sprite flag the check. //note to self: make this apply to inhand rendering also - NK
#define TRAIT_NO_INHAND_ICON "no_inhand_icon"
