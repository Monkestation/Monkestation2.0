...
#define LAZY_TEMPLATE_KEY_WONDERLAND "LT_WONDERLAND"
#define LAZY_TEMPLATE_KEY_GOLDENEYE_SATELLITE "LT_GOLDENEYESAT"
...
#define LAZY_TEMPLATE_KEY_LIST_ALL(...) list( \
	...
	"Wonderland" = LAZY_TEMPLATE_KEY_WONDERLAND, \
	"GoldenEye Satellite" = LAZY_TEMPLATE_KEY_GOLDENEYE_SATELLITE, \
)
