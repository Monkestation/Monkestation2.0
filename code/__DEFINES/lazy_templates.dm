...
#define LAZY_TEMPLATE_KEY_ASSOPBASE "LT_ASSOPS"
#define LAZY_TEMPLATE_KEY_COMMANDOBASE "LT_COMMANDOBASE"
#define LAZY_TEMPLATE_KEY_APID_HIVES "LT_APIDHIVES"
...
#define LAZY_TEMPLATE_KEY_LIST_ALL(...) list( \
	...
	"Assault Operative Base" = LAZY_TEMPLATE_KEY_ASSOPBASE, \
	"Commando Operative Base" = LAZY_TEMPLATE_KEY_COMMANDOBASE, \
	"Apid Hives" = LAZY_TEMPLATE_KEY_APID_HIVES, \
)
