...
#define PREFERENCE_TAB_GAME_PREFERENCES_CHARACTER -1
#define PREFERENCE_TAB_GAME_PREFERENCES_SETTINGS 0
#define PREFERENCE_TAB_GAME_PREFERENCES_KEY_BINDINGS 1
#define PREFERENCE_TAB_GAME_PREFERENCES_VOLUME 2
