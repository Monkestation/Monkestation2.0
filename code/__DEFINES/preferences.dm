...
#define PREFERENCE_TAB_GAME_PREFERENCES_SETTINGS "settings"
#define PREFERENCE_TAB_GAME_PREFERENCES_KEY_BINDINGS "key_bindings"
#define PREFERENCE_TAB_GAME_PREFERENCES_VOLUME "volume"
