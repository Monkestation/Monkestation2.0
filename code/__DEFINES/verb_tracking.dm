...
/// This is the underlying workhorse. This macro runs the verb we want to execute and tracks its time, assuming this is being ran as a verb and all
...
/// General case "verb like thing" shim, covers verbs and also procs (which we can use as verbs sometimes)
