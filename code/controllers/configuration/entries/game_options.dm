...
/datum/config_entry/string/alert_yellow
	default = "The security alert level has been changed to yellow. There is currently a critical engineering issue on board %STATION_NAME%. Station automation drones have been granted relaxed protocols temporarily. Crewmembers are advised to avoid damaged areas, and report them as needed."
