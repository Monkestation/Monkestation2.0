...
/obj/machinery/computer/shuttle/caravan/syndicate1
	...
	possible_destinations = "caravansyndicate1_custom;caravansyndicate1_ambush;syndicate_listening_post;syndicate_depot" //monkestation edit: new listening post
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate1
	...
	jump_to_ports = list("caravansyndicate1_ambush" = 1, "syndicate_listening_post" = 1, "syndicate_depot" = 1) //monkestation edit: new listening post
	view_range = 0
	x_offset = 2
	y_offset = 0
...
/obj/machinery/computer/shuttle/caravan/syndicate2
	...
	possible_destinations = "caravansyndicate2_custom;caravansyndicate2_ambush;syndicate_listening_post;syndicate_depot" //monkestation edit: new listening post
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate2
	...
	jump_to_ports = list("caravansyndicate2_ambush" = 1, "syndicate_listening_post" = 1, "syndicate_depot" = 1) //monkestation edit: new listening post
	view_range = 0
	x_offset = 0
	y_offset = 2
...
/obj/machinery/computer/shuttle/caravan/syndicate3
	...
	possible_destinations = "caravansyndicate3_custom;caravansyndicate3_ambush;syndicate_listening_post;syndicate_depot" //monkestation edit: new listening post
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate3
	...
	jump_to_ports = list("caravansyndicate3_ambush" = 1, "syndicate_listening_post" = 1, "syndicate_depot" = 1) //monkestation edit: new listening post
	view_range = 2.5
	x_offset = -1
	y_offset = -3
