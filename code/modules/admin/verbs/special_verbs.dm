...
DEFINE_PROC_VERB(/client, show_verbs, "Adminverbs - Show", "", FALSE, ADMIN_CATEGORY_MAIN) //MONKE EDIT Added from AVD system hide_verbs
...
DEFINE_PROC_VERB(/client, readmin, "Readmin", "Regain your admin powers.", FALSE, "Admin") //MONKE EDIT Added from /client/New
