...
/obj/item/clothing/head/beanie/black
	name = "black beanie"
	SETUP_MAP_ICONS("beanie", "/obj/item/clothing/head/beanie/black")
...
/obj/item/clothing/head/beanie/darkblue
	...
	SETUP_MAP_ICONS("beanie", "/obj/item/clothing/head/beanie/darkblue")
	greyscale_colors = "#1E85BC#1E85BC"

/obj/item/clothing/head/beanie/yellow
	name = "yellow beanie"
	SETUP_MAP_ICONS("beanie", "/obj/item/clothing/head/beanie/yellow")
	greyscale_colors = "#E0C14F#E0C14F"

/obj/item/clothing/head/beanie/orange
	name = "orange beanie"
	SETUP_MAP_ICONS("beanie", "/obj/item/clothing/head/beanie/orange")
	greyscale_colors = "#C67A4B#C67A4B"

/obj/item/clothing/head/beanie/christmas
	name = "christmas beanie"
	SETUP_MAP_ICONS("beanie", "/obj/item/clothing/head/beanie/christmas")
	greyscale_colors = "#038000#960000"

/obj/item/clothing/head/beanie/durathread
	name = "durathread beanie"
	desc = "A beanie made from durathread, its resilient fibres provide some protection to the wearer."
	SETUP_MAP_ICONS("beanie", "/obj/item/clothing/head/beanie/durathread")
