...
/obj/item/clothing/gloves/latex/nitrile/deforest
	...
	desc = "A pair of high-visibility gloves designed by Deforest Pharmaceutical for search and rescue, reinforced with thicker cut-resistant fabrics and lined with a heat insulation layer, these gloves can hold their own in most environments."
	icon_state = "hivisgloves"
	worn_icon = "hivisgloves"
