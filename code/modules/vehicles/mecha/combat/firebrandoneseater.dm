/obj/vehicle/sealed/mecha/firebrandone
...
// this thing is gods op, solo crew
...
/obj/vehicle/sealed/mecha/firebrandone/Moved(atom/old_loc, movement_dir, forced, list/old_locs, momentum_change = TRUE)
	. = ..()
	if(has_gravity())
		for(var/mob/living/carbon/human/future_pancake in loc)
			run_over(future_pancake)

/obj/vehicle/sealed/mecha/firebrandone/proc/run_over(mob/living/carbon/human/crushed)
...
/obj/vehicle/sealed/mecha/firebrandone/generate_actions()
	. = ..()
	initialize_passenger_action_type(/datum/action/vehicle/sealed/mecha/mech_zoom)

// better parts since TC
/obj/vehicle/sealed/mecha/firebrandone/add_cell()
	cell = new /obj/item/stock_parts/cell/super(src)

/obj/vehicle/sealed/mecha/firebrandone/add_capacitor()
