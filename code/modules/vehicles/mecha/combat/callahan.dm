/obj/vehicle/sealed/mecha/callahan
	desc = "The pride of the Caovish navy, named after the first archon of the Warden empire. For some unknown reason, NT has used ultra advanced bluespace tech to shrink it to station size, and roboticized it to need only 1 crew. Doom encarnate, makes heretic worms look like earth worms."
