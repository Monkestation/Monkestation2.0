...
/obj/item/gun/energy/plasmacutter
	...
	var/charge_weld = (0.05 * STANDARD_CELL_CHARGE) //amount of charge used up to start action (multiplied by amount) and per progress_flash_divisor ticks of welding
