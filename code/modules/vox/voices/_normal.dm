...
/datum/vox_voice/normal
	...
	sounds = list(
		...
		"afternoon" = 'sound/announcer/vox_fem/afternoon.ogg',
		...
		"alone" = 'sound/announcer/vox_fem/alone.ogg',
		...
		"amber" = 'sound/announcer/vox_fem/amber.ogg',
		"america" = 'sound/announcer/vox_fem/america.ogg',
		"american" = 'sound/announcer/vox_fem/american.ogg',
		...
		"anarchy" = 'sound/announcer/vox_fem/anarchy.ogg',
		...
		"anomaly" = 'sound/announcer/vox_fem/anomaly.ogg',
		...
		"ape" = 'sound/announcer/vox_fem/ape.ogg',
		"apid" = 'sound/announcer/vox_fem/apid.ogg',
		"apprehend" = 'sound/announcer/vox_fem/apprehend.ogg',
		"approach" = 'sound/announcer/vox_fem/approach.ogg',
		"arachnid" = 'sound/announcer/vox_fem/arachnid.ogg',
		...
		"artifact" = 'sound/announcer/vox_fem/artifact.ogg',
		"artillery" = 'sound/announcer/vox_fem/artillery.ogg',
		"ashwalker" = 'sound/announcer/vox_fem/ashwalker.ogg',
		...
		"blueshield" = 'sound/announcer/vox_fem/blueshield.ogg',
		...
		"bonk" = 'sound/announcer/vox_fem/bonk.ogg',
		"borer" = 'sound/announcer/vox_fem/borer.ogg',
		...
		"box" = 'sound/announcer/vox_fem/box.ogg',
		...
		"brother" = 'sound/announcer/vox_fem/brother.ogg',
		...
		"cannabis" = 'sound/announcer/vox_fem/cannabis.ogg',
		"cap" = 'sound/announcer/vox_fem/cap.ogg',
		"capitalism" = 'sound/announcer/vox_fem/capitalism.ogg',
		"capitalist" = 'sound/announcer/vox_fem/capitalist.ogg',
		...
		"chemistry" = 'sound/announcer/vox_fem/chemistry.ogg',
		"chicken" = 'sound/announcer/vox_fem/chicken.ogg',
		"chief" = 'sound/announcer/vox_fem/chief.ogg',
		"chimpanzee" = 'sound/announcer/vox_fem/chimpanzee.ogg',
		...
		"cigarette" = 'sound/announcer/vox_fem/cigarette.ogg',
		"circuit" = 'sound/announcer/vox_fem/circuit.ogg',
		"clanker" = 'sound/announcer/vox_fem/clanker.ogg',
		...
		"clone" = 'sound/announcer/vox_fem/clone.ogg',
		"cloning" = 'sound/announcer/vox_fem/cloning.ogg',
		...
		"cocaine" = 'sound/announcer/vox_fem/cocaine.ogg',
		...
		"commie" = 'sound/announcer/vox_fem/commie.ogg',
		"communication" = 'sound/announcer/vox_fem/communication.ogg',
		"communism" = 'sound/announcer/vox_fem/communism.ogg',
		"communist" = 'sound/announcer/vox_fem/communist.ogg',
		...
		"crewsimov" = 'sound/announcer/vox_fem/crewsimov.ogg',
		...
		"cyberpsycho" = 'sound/announcer/vox_fem/cyberpsycho.ogg',
		"cybersun" = 'sound/announcer/vox_fem/cybersun.ogg',
		...
		"deez" = 'sound/announcer/vox_fem/deez.ogg',
		"defense" = 'sound/announcer/vox_fem/defense.ogg',
		"deforest" = 'sound/announcer/vox_fem/deforest.ogg',
		...
		"derelict" = 'sound/announcer/vox_fem/derelict.ogg',
		...
		"donk" = 'sound/announcer/vox_fem/donk.ogg',
		...
		"drug" = 'sound/announcer/vox_fem/drug.ogg',
		"drugs" = 'sound/announcer/vox_fem/drugs.ogg',
		...
		"epsilon" = 'sound/announcer/vox_fem/epsilon.ogg',
		...
		"evening" = 'sound/announcer/vox_fem/evening.ogg',
		...
		"fart" = 'sound/announcer/vox_fem/fart.ogg',
		"farthest" = 'sound/announcer/vox_fem/farthest.ogg',
		"farting" = 'sound/announcer/vox_fem/farting.ogg',
		...
		"fentanyl" = 'sound/announcer/vox_fem/fentanyl.ogg',
		...
		"fish" = 'sound/announcer/vox_fem/fish.ogg',
		...
		"floran" = 'sound/announcer/vox_fem/floran.ogg',
		"florida" = 'sound/announcer/vox_fem/florida.ogg',
		"flux" = 'sound/announcer/vox_fem/flux.ogg',
		...
		"fortnight" = 'sound/announcer/vox_fem/fortnight.ogg',
		...
		"freedom" = 'sound/announcer/vox_fem/freedom.ogg',
		...
		"friend" = 'sound/announcer/vox_fem/friend.ogg',
		"friends" = 'sound/announcer/vox_fem/friends.ogg',
		"from" = 'sound/announcer/vox_fem/from.ogg',
		"front" = 'sound/announcer/vox_fem/front.ogg',
		"frontier" = 'sound/announcer/vox_fem/frontier.ogg',
		...
		"gamma" = 'sound/announcer/vox_fem/gamma.ogg',
		...
		"goat" = 'sound/announcer/vox_fem/goat.ogg',
		"goblin" = 'sound/announcer/vox_fem/goblin.ogg',
		...
		"greetings" = 'sound/announcer/vox_fem/greetings.ogg',
		"grenade" = 'sound/announcer/vox_fem/grenade.ogg',
		"grid" = 'sound/announcer/vox_fem/grid.ogg',
		...
		"gyatt" = 'sound/announcer/vox_fem/gyatt.ogg',
		...
		"inspect" = 'sound/announcer/vox_fem/inspect.ogg',
		...
		"interdyne" = 'sound/announcer/vox_fem/interdyne.ogg',
		"intern" = 'sound/announcer/vox_fem/intern.ogg',
		...
		"janny" = 'sound/announcer/vox_fem/janny.ogg',
		...
		"junction" = 'sound/announcer/vox_fem/junction.ogg',
		...
		"kudzu" = 'sound/announcer/vox_fem/kudzu.ogg',
		...
		"mech" = 'sound/announcer/vox_fem/mech.ogg',
		"medbay" = 'sound/announcer/vox_fem/medbay.ogg',
		"medic" = 'sound/announcer/vox_fem/medic.ogg',
		...
		"morning" = 'sound/announcer/vox_fem/morning.ogg',
		"morph" = 'sound/announcer/vox_fem/morph.ogg',
		...
		"music" = 'sound/announcer/vox_fem/music.ogg',
		...
		"nanites" = 'sound/announcer/vox_fem/nanites.ogg',
		...
		"nut" = 'sound/announcer/vox_fem/nut.ogg',
		"nutimov" = 'sound/announcer/vox_fem/nutimov.ogg',
		"nuts" = 'sound/announcer/vox_fem/nuts.ogg',
		...
		"oni" = 'sound/announcer/vox_fem/oni.ogg',
		"oof" = 'sound/announcer/vox_fem/oof.ogg',
		"ook" = 'sound/announcer/vox_fem/ook.ogg',
		"oozeling" = 'sound/announcer/vox_fem/oozeling.ogg',
		...
		"origin" = 'sound/announcer/vox_fem/origin.ogg',
		"ornithid" = 'sound/announcer/vox_fem/ornithid.ogg',
		"oscar" = 'sound/announcer/vox_fem/oscar.ogg',
		"out" = 'sound/announcer/vox_fem/out.ogg',
		"outage" = 'sound/announcer/vox_fem/outage.ogg',
		...
		"pharmacy" = 'sound/announcer/vox_fem/pharmacy.ogg',
		"pipe" = 'sound/announcer/vox_fem/pipe.ogg',
		"piping" = 'sound/announcer/vox_fem/piping.ogg',
		"piss" = 'sound/announcer/vox_fem/piss.ogg',
		"pissing" = 'sound/announcer/vox_fem/pissing.ogg',
		"pizza" = 'sound/announcer/vox_fem/pizza.ogg',
		"plague" = 'sound/announcer/vox_fem/plague.ogg',
		...
		"positronic" = 'sound/announcer/vox_fem/positronic.ogg',
		...
		"purge" = 'sound/announcer/vox_fem/purge.ogg',
		...
		"radio" = 'sound/announcer/vox_fem/radio.ogg',
		...
		"ranch" = 'sound/announcer/vox_fem/ranch.ogg',
		"rapid" = 'sound/announcer/vox_fem/rapid.ogg',
		"rat" = 'sound/announcer/vox_fem/rat.ogg',
		...
		"real" = 'sound/announcer/vox_fem/real.ogg',
		"red" = 'sound/announcer/vox_fem/red.ogg',
		"reject" = 'sound/announcer/vox_fem/reject.ogg',
		"rejected" = 'sound/announcer/vox_fem/rejected.ogg',
		...
		"reporter" = 'sound/announcer/vox_fem/reporter.ogg',
		...
		"reset" = 'sound/announcer/vox_fem/reset.ogg',
		...
		"revenant" = 'sound/announcer/vox_fem/revenant.ogg',
		...
		"rizz" = 'sound/announcer/vox_fem/rizz.ogg',
		...
		"satyr" = 'sound/announcer/vox_fem/satyr.ogg',
		...
		"scotland" = 'sound/announcer/vox_fem/scotland.ogg',
		...
		"shitcurity" = 'sound/announcer/vox_fem/shitcurity.ogg',
		"shitlord" = 'sound/announcer/vox_fem/shitlord.ogg',
		"shits" = 'sound/announcer/vox_fem/shits.ogg',
		"shitsec" = 'sound/announcer/vox_fem/shitsec.ogg',
		...
		"short" = 'sound/announcer/vox_fem/short.ogg',
		"shortage" = 'sound/announcer/vox_fem/shortage.ogg',
		...
		"slasher" = 'sound/announcer/vox_fem/slasher.ogg',
		...
		"smoke" = 'sound/announcer/vox_fem/smoke.ogg',
		...
		"spicy" = 'sound/announcer/vox_fem/spicy.ogg',
		...
		"squirrel" = 'sound/announcer/vox_fem/squirrel.ogg',
		...
		"superior" = 'sound/announcer/vox_fem/superior.ogg',
		"supermatter" = 'sound/announcer/vox_fem/supermatter.ogg',
		"supply" = 'sound/announcer/vox_fem/supply.ogg',
		"supremacist" = 'sound/announcer/vox_fem/supremacist.ogg',
		"supremacy" = 'sound/announcer/vox_fem/supremacy.ogg',
		...
		"telecommunication" = 'sound/announcer/vox_fem/telecommunication.ogg',
		...
		"teratoma" = 'sound/announcer/vox_fem/teratoma.ogg',
		...
		"today" = 'sound/announcer/vox_fem/today.ogg',
		"tomorrow" = 'sound/announcer/vox_fem/tomorrow.ogg',
		...
		"tram" = 'sound/announcer/vox_fem/tram.ogg',
		...
		"tundra" = 'sound/announcer/vox_fem/tundra.ogg',
		"tunnel" = 'sound/announcer/vox_fem/tunnel.ogg',
		"turbine" = 'sound/announcer/vox_fem/turbine.ogg',
		...
		"union" = 'sound/announcer/vox_fem/union.ogg',
		...
		"vampire" = 'sound/announcer/vox_fem/vampire.ogg',
		"vapor" = 'sound/announcer/vox_fem/vapor.ogg',
		"vault" = 'sound/announcer/vox_fem/vault.ogg',
		...
		"walter" = 'sound/announcer/vox_fem/walter.ogg',
		...
		"weed" = 'sound/announcer/vox_fem/weed.ogg',
		...
		"worms" = 'sound/announcer/vox_fem/worms.ogg',
		...
		"yesterday" = 'sound/announcer/vox_fem/yesterday.ogg',
