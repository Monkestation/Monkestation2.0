...
/datum/supply_pack/imports/syndicat
	name = "Stolen Crate"
	desc = "Psst.. bud... want to buy this crate I stole from some syndies in space? \
		just don't mind the scratchmarks... i had a little trouble getting it inside."
	contraband = TRUE
	cost = CARGO_CRATE_VALUE * 4
	contains = list(
