...
/obj/item/seeds/tobacco
	...
	reagents_add = list(/datum/reagent/drug/nicotine = 0.2) ///datum/reagent/consumable/nutriment = 0.03 Thy shall not get fat from smoking
...
/obj/item/seeds/tobacco/space
	...
	reagents_add = list(/datum/reagent/medicine/salbutamol = 0.1, /datum/reagent/drug/nicotine = 0.2, /datum/reagent/oxygen = 0.2)  ///datum/reagent/consumable/nutriment = 0.03 Thy shall not get fat from smoking
	rarity = 20
