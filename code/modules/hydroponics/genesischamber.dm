/obj/machinery/genesis_chamber
	...
	icon = 'icons/obj/machines/genesis_chamber.dmi'
	icon_state = "genesis_chamber_off"
	density = TRUE
	circuit = /obj/item/circuitboard/machine/genesischamber
...
/obj/machinery/genesis_chamber/add_context(atom/source, list/context, obj/item/held_item, mob/user)
	. = ..()

	context[SCREENTIP_CONTEXT_LMB] = "Empty chamber"
	context[SCREENTIP_CONTEXT_RMB] = on ? "Turn off" : "Turn on"
