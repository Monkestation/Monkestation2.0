 ...
 */
/datum/computer_file/program/nt_rep_comments/proc/post_status(command, data1, data2)
 ...
 * * lower - Bottom text
 */
/datum/computer_file/program/nt_rep_comments/proc/post_message(upper, lower)
 ...
 */
/datum/computer_file/program/nt_rep_comments/proc/post_picture(picture)
...
/datum/computer_file/program/nt_rep_comments/ui_act(action, list/params, datum/tgui/ui)
	switch(action)
		if("setStatusMessage")
