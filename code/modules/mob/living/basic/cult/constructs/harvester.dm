...
/mob/living/basic/construct/harvester/heretic/proc/link_master(mob/self, mob/master)
	SIGNAL_HANDLER
	src.master = master
	RegisterSignal(master, COMSIG_LIVING_DEATH, PROC_REF(on_master_death))

/mob/living/basic/construct/harvester/heretic/proc/on_master_death(mob/self, mob/master)
	SIGNAL_HANDLER
	to_chat(src, span_userdanger("Your link to the mansus suddenly snaps as your master [master] perishes! Without [master.p_their()] support, your body crumbles..."))
