...
/mob/living/silicon/robot/proc/notify_ai(notifytype, oldname, newname)
	...
	switch(notifytype)
		if(AI_NOTIFICATION_NEW_BORG) //New Cyborg
			to_chat(connected_ai, "<br><br>[span_notice("NOTICE - New cyborg connection detected: <a href='byond://?src=[REF(connected_ai)];track_cyborg=[html_encode(name)]'>[name]</a>")]<br>")
		...
		if(AI_NOTIFICATION_AI_SHELL) //New Shell
			to_chat(connected_ai, "<br><br>[span_notice("NOTICE - New cyborg shell detected: <a href='byond://?src=[REF(connected_ai)];track_cyborg=[html_encode(name)]'>[name]</a>")]<br>")
		...
		if(AI_NOTIFICATION_CYBORG_DEATH)
			to_chat(connected_ai, "<br><br>[span_notice("NOTICE - Cyborg unit failure detected: <a href='byond://?src=[REF(connected_ai)];track_cyborg=[html_encode(name)]'>[name]</a>")]<br>")
