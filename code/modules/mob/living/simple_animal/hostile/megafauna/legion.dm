...
/mob/living/simple_animal/hostile/megafauna/legion
	...
	mob_biotypes = MOB_ORGANIC|MOB_EPIC|MOB_UNDEAD|MOB_MINING
	speed = 5
	ranged = TRUE
	del_on_death = TRUE
	retreat_distance = 5
...
/mob/living/simple_animal/hostile/megafauna/legion/death()
	...
	for(var/mob/living/simple_animal/hostile/megafauna/legion/other in GLOB.mob_living_list)
		if(other != src)
			...
			break
	if(last_legion)
		loot = list(/obj/item/storm_staff, /obj/item/book/granter/crafting_recipe/dusting/summoning_flute/legion)
		elimination = FALSE
