/datum/species/tundra
	...
	bodypart_overrides = list(
		BODY_ZONE_HEAD = /obj/item/bodypart/head/tmoth,
		BODY_ZONE_CHEST = /obj/item/bodypart/chest/tmoth,
		BODY_ZONE_L_ARM = /obj/item/bodypart/arm/left/tmoth,
		BODY_ZONE_R_ARM = /obj/item/bodypart/arm/right/tmoth,
		BODY_ZONE_L_LEG = /obj/item/bodypart/leg/left/tmoth,
		BODY_ZONE_R_LEG = /obj/item/bodypart/leg/right/tmoth,
	)

/datum/species/tundra/regenerate_organs(mob/living/carbon/C, datum/species/old_species, replace_current= TRUE, list/excluded_zones, visual_only)
	. = ..()
	if(ishuman(C))
		var/mob/living/carbon/human/H = C
		handle_mutant_bodyparts(H)

/datum/species/tundra/random_name(gender,unique,lastname)
	if(unique)
...
/datum/species/tundra/on_species_gain(mob/living/carbon/human/human_who_gained_species, datum/species/old_species, pref_load)
	. = ..()
	RegisterSignal(human_who_gained_species, COMSIG_MOB_APPLY_DAMAGE_MODIFIERS, PROC_REF(damage_weakness))

/datum/species/tundra/on_species_loss(mob/living/carbon/human/C, datum/species/new_species, pref_load)
	. = ..()
	UnregisterSignal(C, COMSIG_MOB_APPLY_DAMAGE_MODIFIERS)

/datum/species/tundra/proc/damage_weakness(datum/source, list/damage_mods, damage_amount, damagetype, def_zone, sharpness, attack_direction, obj/item/attacking_item)
	SIGNAL_HANDLER

	if(istype(attacking_item, /obj/item/melee/flyswatter))
		damage_mods += 10 // Yes, a 10x damage modifier

/datum/species/tundra/randomize_features(mob/living/carbon/human/human_mob)
	human_mob.dna.features["moth_markings"] = pick(GLOB.moth_markings_list)
	randomize_external_organs(human_mob)

/datum/species/tundra/get_scream_sound(mob/living/carbon/human/human)
	return 'sound/voice/moth/scream_moth.ogg'

/datum/species/tundra/get_species_description()
...
/datum/species/tundra/create_pref_unique_perks()
