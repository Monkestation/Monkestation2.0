/// Strange mix between a positronic brain and a real one, ideally positronic brains would be organs and able to go directly
/// into IRCs rather than this existing, but no luck with that.

/obj/item/organ/internal/brain/synth/irc
	name = "specialized compact positronic brain"
	desc = "A compact internal radio component, specialized for use in the construction of Integrated Robotic Chassis, IRCs, who serve their creator."
...
/obj/item/organ/internal/brain/synth/irc/proc/ping_ghosts(msg, newlymade)
...
/obj/item/organ/internal/brain/synth/irc/attack_self(mob/user)
...
/obj/item/organ/internal/brain/synth/irc/click_alt(mob/living/user)
...
/obj/item/organ/internal/brain/synth/irc/proc/check_success()
	searching = FALSE
	update_appearance()
...
/obj/item/organ/internal/brain/synth/irc/attack_ghost(mob/user)
	activate(user)

/obj/item/organ/internal/brain/synth/irc/proc/is_occupied()
	if(brainmob.key)
		return TRUE
	if(iscyborg(loc))
...
/obj/item/organ/internal/brain/synth/irc/proc/activate(mob/user)
	if(QDELETED(brainmob))
		return
...
/obj/item/organ/internal/brain/synth/irc/transfer_identity(mob/living/carbon/transfered_user)
...
/obj/item/organ/internal/brain/synth/irc/proc/transfer_personality(mob/candidate)
	if(QDELETED(brainmob))
		return
...
/obj/item/organ/internal/brain/synth/irc/examine(mob/user)
	. = ..()
	if(brainmob?.key)
...
/obj/item/organ/internal/brain/synth/irc/Initialize(mapload, autoping = TRUE)
	. = ..()
	var/new_name
...
/obj/item/organ/internal/brain/synth/irc/update_icon_state()
	. = ..()
	if(searching)
...
/obj/item/organ/internal/brain/synth/irc/attackby(obj/item/O, mob/user, params)
	return
