...
/obj/machinery/vending/wardrobe/sec_wardrobe
	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/mask/thermal_balaclava = 3,
			),
		),
		list(
			"name" = "Under",
	...
	contraband = list(
		...
		/obj/item/clothing/under/civilprotection_uniform = 1,
		/obj/item/clothing/shoes/civilprotection_boots = 1,
		/obj/item/clothing/gloves/civilprotection_gloves = 1,
		/obj/item/clothing/head/helmet/civilprotection_helmet = 1,
		/obj/item/clothing/suit/armor/civilprotection_vest = 1,
