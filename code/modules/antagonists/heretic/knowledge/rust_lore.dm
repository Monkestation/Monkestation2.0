/datum/heretic_knowledge_tree_column/rust
	...
	tips = list(
		...
		"Your Salvaged Remains is only empowered while you are on your rusted tiles. If you want the most out of its power, stay on your rusted tiles.",
...
/datum/heretic_knowledge/ultimate/rust_final/proc/on_life(mob/living/source, seconds_per_tick)
	...
	need_mob_update += source.adjustCloneLoss(-base_heal_amt, updating_health = FALSE)
	source.stamina?.adjust(base_heal_amt * 4)
